      ...
      <div className="overflow-hidden">
        ...
        <div className="bg-warm-gray-50">
          <div className="py-24 lg:py-32">
            <div className="relative z-2 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 max-w-3xl text-xl text-warm-gray-500">
                Ready to experience something magical? Let us pamper you!
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="relative overflow-hidden bg-gradient-to-b from-rose-300 to-rose-300 py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  <p className="mt-6 max-w-3xl text-base text-teal-50">
                    Radiant Skin and Beauty is located in the heart of Leawood,
                    KS. We are open 6 days a week and offer extended hours. We
                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-red-50">
                      <PhoneIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-3">+1 (913) 258-8242</span>
                    </dd>
                    <dt>
                    ...
                    <dd className="flex text-base text-red-50">
                      ...
                      />
                      <span className="ml-3">
                        radiantskinandbeautykc@gmail.com
                      </span>
                    </dd>
                  </dl>
